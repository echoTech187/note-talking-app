...
@section('content')
    <div class="overflow-hidden flex items-center justify-center transition-opacity opacity-90 duration-750 overflow-x-hidden starting:opacity-0 w-screen min-h-screen bg-[#0a0a0a]"
